...
function convert(txt, nOption) {
    if (nOption == 0) //转换成简体
        return simplized(txt);
    if (nOption == 1)
        return traditionalized(txt); //转换成繁体
    if (nOption == 2)
        return qqlized(txt); //转换成qq个性繁体
}