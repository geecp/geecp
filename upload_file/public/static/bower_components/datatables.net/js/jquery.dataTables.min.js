...
(function(h) {
    ...
    n.defaults = {
        ...
        oClasses: {},
        oLanguage: {
            oAria: { sSortAscending: ": 激活升序状态", sSortDescending: ": 激活降序状态" },
            oPaginate: { sFirst: "首页", sLast: "尾页", sNext: "下一页", sPrevious: "上一页" },
            sEmptyTable: "暂无数据",
            sInfo: "展示 第 _START_ 条到 _END_ 条数据 总共 _TOTAL_ 条数据",
            sInfoEmpty: "展示 第 0 条到 0 条数据 总共 0 条数据",
            sInfoFiltered: "(从总数据中过滤掉 _MAX_ 条数据)",
            sInfoPostFix: "",
            sDecimal: "",
            sThousands: ",",
